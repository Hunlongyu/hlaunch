...
| PLAT-TRAY-001 | 托盘显示/隐藏、设置、退出与 Explorer 恢复 | `windows-integration.md` | 生命周期集成测试 + Explorer 运行验证 | 部分验证（2026-08-26：真实图标矩形、选择回调 Toggle、设置入口、可复用原生设置窗、外观配置与标准对话框键盘路由和生命周期测试通过；激活/启动设置项、菜单人工操作与 Explorer 重启验证未完成） |
