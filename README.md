...
设置页现已支持主题、Solid/Mica/Acrylic/Tabbed 背景材质、30%–100% 整体不透明度、全局快捷键重绑、八方向边缘热区、多显示器模式、边缘宽度、角落大小、停留/采样/冷却时间、全屏抑制和当前用户开机启动；保存后立即应用。EXE Manifest 已启用 Common Controls v6，标准 Win32 控件与原生对话框使用 Windows 视觉样式。
